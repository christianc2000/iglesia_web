                        ...
                        <td>
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item" href='?controller=personas&action=edit&id=<?php echo $persona->id; ?>'>Editar</a></li>
                                    <li><a class="dropdown-item" href="?controller=personas&action=parentezco&id=<?php echo $persona->id; ?>">Parentezco</a></li>
                                    <li><a class="dropdown-item" href='?controller=personas&action=delete&id=<?php echo $persona->id; ?>'>Eliminar</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
